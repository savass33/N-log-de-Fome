...
const MOCK_USERS: Record<UserRole, IUser> = {
  admin: { id: 'admin-001', name: 'Admin Supremo', email: 'admin@nlogdefome.com', role: 'admin' },
  restaurant: { id: 'rest-001', name: 'Restaurante da Boa', email: 'restaurante@nlogdefome.com', role: 'restaurant', restaurantId: 'r1' },
  client: { id: 'client-001', name: 'Ana Silva', email: 'ana@nlogdefome.com', role: 'client', clientId: 'c1' },
};
